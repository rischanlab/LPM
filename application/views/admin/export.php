...
<link href="<?php echo base_url(); ?>res/css/dosen-style.css"
	rel="stylesheet" type="text/css" />
<link rel="stylesheet"
	href="<?php echo base_url();?>public/css/angkatan.css" type="text/css" />
<link rel="stylesheet"
	href="<?php echo base_url();?>assets/js/jquery-ui.css" type="text/css"
	media="all" />
<link rel="stylesheet"
	href="<?php echo base_url();?>assets/js/ui.theme.css" type="text/	css"
	media="all" />
...
<div id="bg-isi">
	<h3>Silahkan Pilih Nama Kelompok kemudian Tekan Tombol Lihat Anggota
		Kelompok</h3>
	<center>
